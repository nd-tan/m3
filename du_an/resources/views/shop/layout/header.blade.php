                ...
                <div class="col-lg-6 col-md-6">
                    <div class="header__top__right">
                        ...
                        <div class="header__top__right__auth">
                            ...
                            @else
                            <a href="{{route('shop.login')}}"><i class="fa fa-user"></i> Đăng Nhập</a>
                            @endif
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-lg-3">
                <div class="header__logo">
                    <a href="./index.html"><img src="{{asset('assets/shop/img/logo.png')}}" alt=""></a>
                </div>
            </div>
            <div class="col-lg-6">
                    ...
                    <ul>
                        ...
                        <li><a href="#">Tùy Chọn</a>
                            <ul class="header__menu__dropdown">
                                ...
                                <li><a href="{{route('checkOuts')}}">Thanh Toán</a></li>
