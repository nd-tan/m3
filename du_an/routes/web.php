...
Route::prefix('/')->middleware(['auth', 'revalidate'])->group(function () {
    ...
    Route::prefix('brands')->group(function () {
        ...
        ////xóa
        Route::delete('/deleted/{id}', [BrandController::class, 'deleted'])->name('brand.deleted');
        /////xóa mềm
        Route::delete('/destroy/{id}', [BrandController::class, 'destroy'])->name('brand.delete');
        Route::get('/softdelete', [BrandController::class, 'softdelete'])->name('brand.softdelete');
        Route::get('/restore/{id}', [BrandController::class, 'retrieve'])->name('brand.restore');
    });
    ///////////sản phẩm
    ...
    Route::prefix('message')->group(function () {
        ...
        // /////delete
        // Route::delete('/deleted/{id}',[MessageController::class,'deleted'])->name('message.deleted');
        // // /////delete mềm
        // Route::delete('/delete/{id}',[MessageController::class,'destroy'])->name('message.delete');
        // Route::get('/softdelete',[MessageController::class,'softdelete'])->name('message.softdelete');
        // Route::get('/restore/{id}',[MessageController::class,'retrieve'])->name('message.restore');
        // /////change info
        // Route::post('/updateinfo/{id}',[MessageController::class,'update_info'])->name('message.update_info');
        // Route::post('/updatepassword',[MessageController::class,'change_password'])->name('message.updatepassword');
        // Route::get('/info',[MessageController::class,'info'])->name('message.info');
    });
});
